...
export class NFTStorage implements Service {
     ...
     * @returns {Promise<CIDString>}
     */
    static storeCar({ endpoint, token, rateLimiter }: Service, car: Blob | CarReader, { onStoredChunk, maxRetries, decoders }?: import("./lib/interface.js").CarStorerOptions | undefined): Promise<CIDString>;
    /**
     ...
     */
    static status({ endpoint, token, rateLimiter }: Service, cid: string): Promise<import('./lib/interface.js').StatusResult>;
    /**
     ...
     */
    static check({ endpoint, rateLimiter }: import('./lib/interface.js').PublicService, cid: string): Promise<import('./lib/interface.js').CheckResult>;
    /**
     ...
     */
    static delete({ endpoint, token, rateLimiter }: Service, cid: string): Promise<void>;
    /**
     ...
     */
    constructor({ token, endpoint, rateLimiter, }: {
        token: string;
        endpoint?: URL;
